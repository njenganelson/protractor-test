...
describe('Test XYZ bank Portal',function(){
    ...
    it('Verify Deposit',function () {
        cy.get('[ng-click="transactions()"]', {timeout: 10000})
            .contains('Transactions')
            .click()
        expect(cy.get('.ng-binding').contains('3000000'))
        cy.wait(2000)
    ...
    it('Withdraw Funds',function () {
        ...
        cy.get('[type="number"]',{timeout:10000}).type(this.customerDetails.amountToWithdraw)
        cy.get('[type="submit"]')
            .contains('Withdraw',{timeout:10000})
            .click()
        //Confirm New balance
